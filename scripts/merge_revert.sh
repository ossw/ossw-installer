srec_cat ossw-revert.hex -intel -offset - -minimum-addr ossw-installer.hex -intel -o ossw-installer.bin -binary
srec_cat ossw-revert.bin -binary -offset 0x36000 -o ossw-installer_at_0x36000.hex -intel
...
srec_cat ossw-revert-jump.hex -intel ossw-bootloader-s120_at_0x15000.hex -intel s120_at_0x19000.hex -intel ossw-installer_at_0x36000.hex -intel -o ossw-revert-combined.hex -intel
