...
int main(void)
{
    ...
    uint32_t *sd_src_addr = (uint32_t *)0x26000;
    uint32_t sd_size = 0x14000;
    uint32_t *bl_dest_addr = (uint32_t *)0x38000;
    uint32_t *bl_src_addr = (uint32_t *)0x1E000;
    uint32_t bl_size = 0x8000;
    ...
    flash_uicr_erase();
    uint32_t *uicr_app = (uint32_t *)0x10001000;
    flash_word_write(uicr_app, 0x14000);
    uint32_t *uicr_ver = (uint32_t *)0x10001010;
    flash_word_write(uicr_ver, 0xFFFF0049);
