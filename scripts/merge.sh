...
srec_cat ossw-jump.hex -intel ossw-bootloader-s120_at_0x15000.hex -intel s120_at_0x19000.hex -intel ossw-installer_at_0x36000.hex -intel -o ossw-combined.hex -intel
srec_cat ossw-combined.hex -intel -offset - -minimum-addr ossw-combined.hex -intel -o ossw-combined.bin -binary