...
srec_cat ossw-installer-jump.hex -intel ossw-bootloader-s120_at_0x15000.hex -intel s120_at_0x19000.hex -intel ossw-installer_at_0x36000.hex -intel -o ossw-installer-combined.hex -intel
srec_cat ossw-installer-combined.hex -intel -offset - -minimum-addr ossw-installer-combined.hex -intel -o ossw-installer-combined.bin -binary